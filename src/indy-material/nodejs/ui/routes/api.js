...
router.post('/issuer/send_credential_offer', upload.single('file'), auth.isLoggedIn, async function (req, res) {
    ...
    // axios({
    //     method: 'post',
    //     url: 'http://61.33.231.32:8888/register',
    //     data: {
    //         img: base64img
    //     }
    // }).then(function (response) {
    //     let emb_vector = response.data;
    //     console.log(emb_vector);
    //     indy.credentials.emb_vector = emb_vector;
    ...
    let emb_vector = auth_response.data.emb_vec;
    console.log(emb_vector);
    indy.credentials.emb_vector = emb_vector;
